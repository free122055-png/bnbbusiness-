...
async function startServer() {
  ...
  async function runScheduledTransactionCleanup(databaseInstance) {
    ...
    try {
      ...
      const txCollectionRef = (0, import_firestore.collection)(databaseInstance, "transactions");
      const snapshot = await (0, import_firestore.getDocs)(txCollectionRef);
      ...
      for (const docSnap of snapshot.docs) {
        ...
        if (txTime > 0 && txTime < cutoffTime) {
          await (0, import_firestore.deleteDoc)((0, import_firestore.doc)(databaseInstance, "transactions", docSnap.id)).catch((err) => {
  ...
  app.post("/api/verify-device", async (req, res) => {
    try {
      ...
      const userSnap = await (0, import_firestore.getDoc)(userDocRef);
      if (!userSnap.exists()) {
      ...
      const activeTokens = Array.isArray(u.activeDeviceTokens) ? u.activeDeviceTokens : [];
  ...
  app.post("/api/admin/zero-device", async (req, res) => {
    try {
      ...
      await (0, import_firestore.addDoc)((0, import_firestore.collection)(db, "user_notifications"), {
        userId,
        title: "\u{1F4F1} \u099C\u09BF\u09B0\u09CB \u09A1\u09BF\u09AD\u09BE\u0987\u09B8 \u09B0\u09BF\u09B2\u09BF\u099C \u0993 \u0987\u09A8\u09B8\u09CD\u099F\u09CD\u09AF\u09BE\u09A8\u09CD\u099F \u09B2\u0997\u0986\u0989\u099F \u09B8\u09AE\u09CD\u09AA\u09A8\u09CD\u09A8!",
  ...
  app.post("/api/admin/allow-device", async (req, res) => {
    try {
      ...
      await (0, import_firestore.addDoc)((0, import_firestore.collection)(db, "user_notifications"), {
        userId,
        title: "\u{1F513} \u09A1\u09BF\u09AD\u09BE\u0987\u09B8 \u09B2\u0995 \u09B0\u09BF\u09B2\u09BF\u099C \u0993 \u09A8\u09A4\u09C1\u09A8 \u09A1\u09BF\u09AD\u09BE\u0987\u09B8 \u0985\u09A8\u09C1\u09AE\u09CB\u09A6\u09A8 \u09B8\u09AE\u09CD\u09AA\u09A8\u09CD\u09A8!",
